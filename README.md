...
- [📖 School library people ](#-school-library-people-)
...
# 📖 School library people <a name="about-project"></a>

**School library people** a console Ruby application to practice OOP concepts
...
To run the project, if you are on the school_library_people folder path on your terminal you can execute the following command:
...
No acknowledgements needed so far.
...
- **What is this project main purpose?**
  ...
  - To practice creating Ruby console applications.
